...
// Step 2: Nếu user là Dept Admin, thêm PRs của department (không lấy lại PRs đã có ở Step 1)
// Cả 2 điều kiện đều delegable trên SharePoint: = và <>
If(
    varIsDeptAdmin,
    ForAll(
        Filter(
            'SY2425-PR-GeneralInfo',
            Department = varAdminDepartments && Requestor <> User().Email
        ) As DeptPR,
        If(
