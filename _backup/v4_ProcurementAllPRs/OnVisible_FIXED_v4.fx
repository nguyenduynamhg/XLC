...
If(
    varIsProcurement,
    // ===== Procurement Members: load TẤT CẢ PRs =====
    // ID > 0 là delegable → SharePoint trả ALL rows (phân trang tự động, không bị cắt 500/2000)
    // Cho phép search Title, PR_No, Requestor, RejectComment trên local collection
    ClearCollect(colUserPRs, Filter('SY2425-PR-GeneralInfo', ID > 0)),
